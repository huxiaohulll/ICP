...
/***/ "./src/declarations/hello_micro/hello_micro.did.js":
/*!*********************************************************!*\
  !*** ./src/declarations/hello_micro/hello_micro.did.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/hello_micro/index.js":
/*!***********************************************!*\
  !*** ./src/declarations/hello_micro/index.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "idlFactory": () => (/* reexport safe */ _hello_micro_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   "canisterId": () => (/* binding */ canisterId),
/* harmony export */   "createActor": () => (/* binding */ createActor),
/* harmony export */   "hello_micro": () => (/* binding */ hello_micro)
/* harmony export */ });
...
/* harmony import */ var _hello_micro_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hello_micro.did.js */ "./src/declarations/hello_micro/hello_micro.did.js");
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hello_micro.did.js")._SERVICE>}
 */
 const createActor = (canisterId, options) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_hello_micro_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the hello_micro canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hello_micro.did.js")._SERVICE>}
 */
 const hello_micro = createActor(canisterId);
...
"use strict";
/*!*********************************************!*\
  !*** ./src/hello_micro_assets/src/index.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_hello_micro__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/hello_micro */ "./src/declarations/hello_micro/index.js");
...
async function post(){
  ...
  try{ 
    await _declarations_hello_micro__WEBPACK_IMPORTED_MODULE_0__.hello_micro.post(otp,text);
    textarea.value = "";
  }catch (err){
    console.log(err)
...
async function load_posts(){
  ...
  let posts = await _declarations_hello_micro__WEBPACK_IMPORTED_MODULE_0__.hello_micro.posts();
  //posts 没有添加新内容，返回
...
async function load_canisterid(){
  ...
  var canisterid = "";
  canisterid = await _declarations_hello_micro__WEBPACK_IMPORTED_MODULE_0__.hello_micro.get_canisterid();
  console.log("hello,world");
  let namep = document.createElement("a");
  namep.innerText = canisterid;
  canister.appendChild(namep);
...
async function load_authorname(){
  ...
  var author = "";
  author = await _declarations_hello_micro__WEBPACK_IMPORTED_MODULE_0__.hello_micro.get_name();
  console.log(author);
...
async function load_follows() {
  var follows = null;
  follows = await _declarations_hello_micro__WEBPACK_IMPORTED_MODULE_0__.hello_micro.follows();
...
async function load_timelines() {
  ...
  let timelines = await _declarations_hello_micro__WEBPACK_IMPORTED_MODULE_0__.hello_micro.timeline();
